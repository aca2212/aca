...
class Post extends Koneksi {
    ...
    public function simpan()
    {
        ...
        $sql = "INSERT INTO tb_post (post_name, post_text, post_date) VALUES (:post_name, :post_text, :post_date)";
        $stmt = $this->db->prepare($sql);
    ...
    public function update()
    {
        ...
        $sql = "UPDATE tb_post SET post_name=:post_name, post_text=:post_text, post_date=:post_date WHERE post_id=:post_id";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(":post_name", $post_name);
        $stmt->bindParam(":post_text", $post_text);
        $stmt->bindParam(":post_date", $post_date);
